...
public class MultiplesChoixActiviteTest
{
    @Rule
    public IntentsTestRule<MultiplesChoixActivite> intentsTestRule = new IntentsTestRule<>(MultiplesChoixActivite.class);
    ...
    public void testIntentBoutonMenu()
    {
        ...
        onView(withId(R.id.MenuA)).perform(click());
