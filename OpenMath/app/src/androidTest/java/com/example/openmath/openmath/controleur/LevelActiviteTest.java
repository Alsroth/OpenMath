...
public class LevelActiviteTest
{
    @Rule
    public IntentsTestRule<DefiActivite> intentsTestRule = new IntentsTestRule<>(DefiActivite.class);


    //Je test que le bouton Level1 mène bien informationDefiActivite.
    @Test
    public void testIntentBoutonLevel1()
    {
    ...
    //Je test que le bouton Level2 mène bien informationDefiActivite.
    @Test
    public void testIntentBoutonLevel()
    {
        ConfigurationTest.isInstrumenteTest = true ;
    ...
    //Je test que le bouton Level3 mène bien informationDefiActivite.
    @Test
    ...
    //Je test que le bouton Level4 mène bien informationDefiActivite.
    @Test
